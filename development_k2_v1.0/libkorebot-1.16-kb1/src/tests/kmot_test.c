 ...
 *--------------------------------------------------------------------
 * $Id: kmot_test.c,v 1.17 2006/10/27 08:41:10 flambercy Exp $
 *--------------------------------------------------------------------
 * $Author: flambercy $
...
int init( int argc , char * argv[] , void * data) 
{
  ...
  kmot_SetSpeedProfile(motor,40,10);
  return 0;
}
...
int main( int argc , char * argv[] )
{
  ...
  if ( argc < 2 ) {
    ...
    kb_msg("motor_name: KoreMotor:PriMotor1  (0x0B)\n");
    kb_msg("            KoreMotor:PriMotor2  (0x0C)\n");
    kb_msg("            KoreMotor:PriMotor3  (0x0D)\n");
    kb_msg("            KoreMotor:PriMotor4  (0x0E)\n");
    kb_msg("            KoreMotor:AltMotor1  (0x0F)\n");
    kb_msg("            KoreMotor:AltMotor2  (0x10)\n");
    kb_msg("            KoreMotor:AltMotor3  (0x11)\n");
    kb_msg("            KoreMotor:AltMotor4  (0x12)\n");
    return 0;
  }
