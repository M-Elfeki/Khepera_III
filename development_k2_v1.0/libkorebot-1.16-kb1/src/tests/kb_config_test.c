 ...
 * 
 * 
 * $Header: /home/cvs/libkorebot/src/tests/kb_config_test.c,v 1.5 2004/11/22 17:54:23 pbureau Exp $
 */

/*--------------------------------------------------------------------*/
/*! 
 * \file   kb_config_test.c korebot lib config module test
 *
 * \brief
 * 	   dump the content of the Korebot library configuration files.
 * 	   (usually located in /etc/korebot to the standard output.
