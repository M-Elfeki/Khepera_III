 ...
 *--------------------------------------------------------------------
 * $Id: koreio_test.c,v 1.5 2005/03/02 15:13:23 lambercy Exp $
 *--------------------------------------------------------------------
 * $Author: lambercy $
 * $Date: 2005/03/02 15:13:23 $
 * $Revision: 1.5 $
 *--------------------------------------------------------------------*/
...
int motor( int argc, char * argv[], void * data)
{
  ...
  ratio = 170 + atoi(argv[1]);
  rc = kio_ChangePWM_ratio(koreio, 5 , ratio);

  ratio = 163 - atoi(argv[2]);
  rc = kio_ChangePWM_ratio(koreio, 4 , ratio);
...
int gripper( int argc, char * argv[], void * data)
{
  ...
  rc = kio_ChangePWM_ratio(koreio, 6 , atoi(argv[1]));

  rc = kio_ChangePWM_ratio(koreio, 7 , atoi(argv[2]));
...
{
  int rc, val;
/* Move the gripper with speed to 0 */
  kio_ChangePWM_ratio(koreio, 4 , 163); usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);usleep(10);
  usleep(1000000);

  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);usleep(10);
  usleep(1000000);

  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);
  usleep(1000000);

  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 80);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);
  ...
  /* Move slowly forward */
  kio_ChangePWM_ratio(koreio, 4 , 161);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 172);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);
  /* Move faster */
  kio_ChangePWM_ratio(koreio, 4 , 160);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 173);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);

  /* Open the gripper and turn on the right */
  kio_ChangePWM_ratio(koreio, 4 , 166);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 177);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);
  usleep(1000000);

  /* close the gripper and move forward */
  kio_ChangePWM_ratio(koreio, 4 , 153);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 180);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(2000000);

  /* go slowly and get the gripper down and opened */
  kio_ChangePWM_ratio(koreio, 4 , 160);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 173);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 80);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);
  ...
  /* stop the motor and close the gripper */
  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 80);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  ...
  /* take the object above the robot and go backward */
  kio_ChangePWM_ratio(koreio, 4 , 171);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 162);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);

  /* turn around on the left */
  kio_ChangePWM_ratio(koreio, 4 , 155);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 162);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);
  ...
  /* go forward */
  kio_ChangePWM_ratio(koreio, 4 , 155);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 178);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(2000000);

  /* stop the motor and pose the object on the floor */
  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 80);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  ...
  /* go backward and move the gripper above the gripper */
  kio_ChangePWM_ratio(koreio, 4 , 168);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 165);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);
  usleep(2000000);

  /* Turn around on the left */
  kio_ChangePWM_ratio(koreio, 4 , 158);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 165);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 0);
  usleep(1000000);

  /* Stop the motor with the gripper opened */
  kio_ChangePWM_ratio(koreio, 4 , 163);usleep(10);
  kio_ChangePWM_ratio(koreio, 5 , 170);usleep(10);
  kio_ChangePWM_ratio(koreio, 6 , 200);usleep(10);
  kio_ChangePWM_ratio(koreio, 7 , 170);
...
int main( int argc , char * argv[] )
{
  ...
  /* Init the KoreIO to drive the Robot */
  kio_ChangePWM_freq(koreio, 0 );
  kio_ConfigIO(koreio,4,2);
  kio_ConfigIO(koreio,5,2);
  kio_ConfigIO(koreio,6,2);
  kio_ConfigIO(koreio,7,2);
  kio_ChangePWM_ratio(koreio, 4 , 163);
  kio_ChangePWM_ratio(koreio, 5 , 170);
  kio_ChangePWM_ratio(koreio, 6 , 80);
  kio_ChangePWM_ratio(koreio, 7 , 170);
